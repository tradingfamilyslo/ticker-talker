...
// Uporabimo || '', da preprečimo sesutje med "build" procesom
...
export async function POST(req: Request) {
  // Preverimo, če ključi sploh obstajajo, preden nadaljujemo
  ...
  if (event.type === 'checkout.session.completed') {
    ...
    if (userId && amountGains > 0) {
      console.log(`Plačilo potrjeno za uporabnika: ${userId}`);
